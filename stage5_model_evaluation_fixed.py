# Credit Card Fraud Detection Analysis - Stage 5: Model Evaluation and Comparison (Fixed)
...
for i, (model_name, result) in enumerate(results.items()):
    ...
    # Get AUC from detailed results
    auc_score = detailed_df[detailed_df['Model'] == model_name]['Test_AUC'].values[0]
